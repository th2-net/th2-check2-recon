...
class Cache(AbstractService):
    ...
    class MessageGroup:
        ...
        def check_no_match_within_timeout(self, actual_timestamp: int, timeout: int, clean_timestamp: Optional[int]):
            if clean_timestamp is not None:
                self.clear_out_of_timeout(clean_timestamp)
